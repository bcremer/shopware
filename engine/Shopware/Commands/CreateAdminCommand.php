 ...
 */
class CreateAdminCommand extends ShopwareCommand
{
    /**
     * {@inheritdoc}
     */
    ...
    protected function ask(OutputInterface $output, $question, $default = null)
    {
        ...
        if ($default === null) {
            ...
            $question = sprintf('<question>%s (%s):</question>', $question, $default);
        }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $output->writeln(array(
            "",
            "<info>Adminuser ".$user->getUsername()." successfully created.</info>",
            ""
        ));
    }
     ...
     * @return int
     */
    protected function getLocaleIdFromLocale($locale)
    {
        $locales = array(
            'de_de' => 1,
            'en_gb' => 2,
